...
class CreditProviderViewTests(UrlResetMixin, TestCase):
    ...
    def _credit_provider_callback(
        self, request_uuid, status,
        provider_id=None, secret_key=None, timestamp=None, sig=None
    ):
        """
        ...
        if secret_key is None:
            secret_key = TEST_CREDIT_PROVIDER_SECRET_KEY
        ...
        if sig is None:
            sig = signature(parameters, secret_key)
